...
export function TemplatesPage() {
  ...
  }, [category, styleKey, price, keyword]);
  ...
  const hasActiveFilter =
    category !== 'all' || styleKey !== 'all' || price !== 'all' || keyword.trim().length > 0;
      ...
      <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-3 mb-6">
        <div>
          ...
          <p className="text-sm text-neutral-600 mt-1">
            共 <span className="font-semibold text-neutral-900">{TEMPLATES.length}</span> 套精选模板，
            按分类、风格、价格任意筛选
          </p>
        </div>
            ...
            >
              ...
              <div className="px-3 py-2.5 border-t border-black/5">
                <div className="flex items-center justify-between gap-2">
                  ...
                  <button
                    type="button"
                    onClick={() => navigate(`/create?templateId=${encodeURIComponent(t.id)}`)}
